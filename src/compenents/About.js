      ...
      <div className='container' style={props.mystyle}>
        ...
        <div className="accordion" id="accordionExample" style={props.mystyle}>
          ...
          <div className="accordion-item">
            ...
            <div id="collapseTwo" className="accordion-collapse collapse" style={props.mystyle} data-bs-parent="#accordionExample">
              <div className="accordion-body">
          ...
          <div className="accordion-item">
            ...
            <div id="collapseThree" className="accordion-collapse collapse" style={props.mystyle} data-bs-parent="#accordionExample">
              <div className="accordion-body">
